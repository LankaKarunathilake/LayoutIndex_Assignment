...
const AllDevice = () => {
  ...
  return (
    <div>
        <br/>
            <center><h3 className="mb-4 pb-2 pb-md-0 mb-md-5">Devices List</h3></center>
            {/* <br />
                ...
                {filteredDevices.map((devices)=>
                    <div class="col">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Serial No: {devices.serialNo}</h5>
                                <p class="card-text">Type: {devices.type}</p>
                                <p class="card-text">Location: {devices.locationName}</p>
                                <p class="card-text">Status: {devices.status}</p>
                                <div className='row'>
